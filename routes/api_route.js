...
// Content Management
router.post("/content/category/create", [cors(corsOptions)], (req, res, next) => {
    content_controller.createCategory(req, res, next);
});
router.post("/content/category/update", [cors(corsOptions)], (req, res, next) => {
    content_controller.updateCategory(req, res, next);
});
router.delete("/content/category/delete/:id", [cors(corsOptions)], (req, res, next) => {
...
router.post("/content/article/update", [cors(corsOptions)], (req, res, next) => {
    content_controller.updateArticle(req, res, next);
});
router.post("/content/article/create", [cors(corsOptions)], (req, res, next) => {
    content_controller.createArticle(req, res, next);
});
router.delete("/content/article/delete/:id", [cors(corsOptions)], (req, res, next) => {
...
router.post("/content/support-record/create", [cors(corsOptions)], (req, res, next) => {
    content_controller.createSupportRec(req, res, next);
});
router.delete("/content/support-record/delete/:id", [cors(corsOptions)], (req, res, next) => {
